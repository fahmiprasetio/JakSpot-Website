  ...
  if (!destination) {
    return (
      <>
        ...
        >
          <h1 style={{ fontSize: '2rem', fontFamily: 'var(--font-display)', marginBottom: '16px' }}>
                  ...
                  >
                    {destination.gallery.map((img, i) => (
                      <div
                        ...
                        onMouseLeave={(e) => {
                          if (activeImage !== i) e.currentTarget.style.opacity = '0.6';
                        }}
                      >
                        <img
                          src={img}
          ...
          >
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
              <div className="reveal" style={{ textAlign: 'center', marginBottom: '40px' }}>
                ...
                >
                  Spot Lain yang <span className="gradient-text">Mirip Vibes-nya</span>
                </h2>
              </div>
